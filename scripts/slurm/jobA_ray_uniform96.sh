#!/bin/bash
# Job A2 — Ray, uniform96 SYN events (32 BAZ × 3 depth), SplittingParameters (φ, δt)
# Output : psi_output/ray_uniform96/
# Submit : cd /home/wl/work/ASPECT/<PROJECT> && sbatch /home/wl/software/ECOMAN2.0-seismology.PSI_D_HFFK/scripts/slurm/jobA_ray_uniform96.sh
#SBATCH -J psi_A2_ray_u96
#SBATCH -p 8358
#SBATCH -N 1
...
#SBATCH -o A2_ray_uniform96_%j.out
#SBATCH -e A2_ray_uniform96_%j.err
...
OBS="${PSI_DIR}/psi_input/DUMMY_SP_uniform96.dat"
