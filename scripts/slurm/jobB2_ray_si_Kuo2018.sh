...
# Submit : cd /home/wl/work/ASPECT/<PROJECT> && sbatch jobB2_ray_si_Kuo2018.sh
#SBATCH -J psi_B2_raysi_kuo
#SBATCH -p 8358
...
#SBATCH --mem=16G
#SBATCH -o B2_ray_si_Kuo2018.out_%j.out
#SBATCH -e B2_ray_si_Kuo2018.err_%j.err
