#!/bin/bash
# Job C96 — HFFK SplittingIntensity, synthetic uniform96, T=4/8/16/20/25/33/50 s
# psi_input: always software PSI_DIR. Output: project psi_output/
# Submit : cd <PROJECT> && sbatch jobC96.sh
#SBATCH -J psi_C_hffk_u96
#SBATCH -p 8358
#SBATCH -N 1
...
#SBATCH -o C_hffk_uniform96_%j.out
#SBATCH -e C_hffk_uniform96_%j.err
...
for T in 4.0 8.0 16.0 20.0 25.0 33.0 50.0; do
    run_hffk "hffk_u96_T${T%.*}s" "$T"
done
echo "===== Job C96 done $(date) ====="
