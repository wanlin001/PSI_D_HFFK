#!/bin/bash
# Job A96 — Ray SplittingIntensity, synthetic uniform96 events (32 BAZ × 3 depth)
# psi_input: always software PSI_DIR (shared). Output: project psi_output/
# Submit : cd <PROJECT> && sbatch jobA96.sh
#SBATCH -J psi_A_raysi_u96
#SBATCH -p 8358
...
#SBATCH --mem=16G
#SBATCH -o A_ray_si_uniform96_%j.out
#SBATCH -e A_ray_si_uniform96_%j.err
