#!/bin/bash
# Job C — HFFK SplittingIntensity, synthetic uniform48, T=4/8/16/20/25/33/50 s
# psi_input: always software PSI_DIR. Output: project psi_output/
# Submit : cd <PROJECT> && sbatch jobC.sh
...
#SBATCH -o C_hffk_uniform48_%j.out
#SBATCH -e C_hffk_uniform48_%j.err
